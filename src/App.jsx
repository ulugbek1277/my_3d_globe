...
  const [cameraStatus, setCameraStatus] = useState('Kutubxonalar yuklanmoqda... Biroz kuting.');
...
    <div style={{ width: '100vw', height: '100vh', background: '#050510', overflow: 'hidden' }}>
      ...
      {/* --- YANGILANGAN VIDEO ELEMENT --- */}
      {/* Endi kamera ekranning pastki chap burchagida ko'rinadi */}
      <video 
        ref={videoRef} 
        style={{ 
            position: 'absolute',
            bottom: '30px',
            left: '30px',
            width: '250px', // Kameraning o'lchamini sozlash
            height: 'auto',
            borderRadius: '10px', // Burchaklarini yumaloqlash
            zIndex: 100, // Boshqa elementlarning ustida turishi uchun
            transform: 'scaleX(-1)', // Oyna effekti (sizni to'g'ri ko'rsatish uchun)
